                                        ...
                                        <?php
                                            ...
                                            foreach ($brands as $brand){?>
                                                <tr>
                                                    ...
                                                    <td class="cell">
                                                        <a href="index.php?controller=brand&action=edit_category&category_id=<?= $brand['category_id']?>">
                                                        ...
                                                        <a class="" onclick="return confirm('Bạn chắc có muốn xóa danh mục <?= $brand['category_name'] ?>? Nếu xóa bạn sẽ xóa tất cả sản phẩm trong danh mục đó?')" href='index.php?controller=brand&action=destroy_category&category_id=<?= $brand['category_id']?>'>
